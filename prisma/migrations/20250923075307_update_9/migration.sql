/*
  ...
  - The values [pending,accepted,in_progress,need_payment] on the enum `order_statuses` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "public"."order_statuses_new" AS ENUM ('pending_confirmation', 'confirmed', 'picked_up', 'in_washing', 'payment_required', 'completed', 'cancelled');
